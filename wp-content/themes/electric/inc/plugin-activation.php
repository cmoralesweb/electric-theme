...
if ( ! class_exists( 'TGM_Plugin_Activation' ) ) {
	...
	class TGM_Plugin_Activation {
		...
		public function notices() {
			...
			/** Admin options pages already output settings_errors, so this is to avoid duplication. Same with theme options */
			if ( 'options-general' !== $current_screen->parent_base && 'appearance_page_theme_options' !== $current_screen->base )
